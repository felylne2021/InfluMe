...
namespace InfluMe.ViewModels
{
    ...
    public class JobDetailPageViewModel : BaseViewModel
    {
        ...
        private static JobDetailPageViewModel detailPageViewModel;
        ...
        /// </summary>
        public static JobDetailPageViewModel BindingContext =>
            detailPageViewModel = PopulateData<JobDetailPageViewModel>("detail.json");
        ...
        {
            if (obj is JobDetailPageViewModel model)
            {
