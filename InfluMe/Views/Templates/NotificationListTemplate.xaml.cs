...
namespace InfluMe.Views.Templates
{
    /// <summary>
    ...
    public partial class NotificationListTemplate : Grid
    {
        /// <summary>
        /// Bindable property to set the parent bindingcontext.
        /// </summary>
        public static readonly BindableProperty ParentBindingContextProperty =
         BindableProperty.Create(nameof(ParentBindingContext), typeof(object), typeof(NotificationListTemplate), null);

        /// <summary>
        /// Initializes a new instance of the <see cref="JobListTemplate"/> class.
        /// </summary>
        public NotificationListTemplate()
        {
